class SearchController < ApplicationController
  def index
    ...
    post_q = Post.search(q, execute: false, load: @what == 'posts',
      page: params[:page], per_page: VenganzasDelPasado::Application.config.posts_search_per_page)
    
    comment_q = Comment.search(q, execute: false, load: @what == 'comments',
      page: params[:page], per_page: VenganzasDelPasado::Application.config.comments_search_per_page)
