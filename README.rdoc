...
Este es el sitio actual de Venganzas del Pasado (http://venganzasdelpasado.com.ar) que reemplaza al anterior hecho con WordPress.
...
MIT License. Copyright 2011 Juan Pablo Schwindt.
