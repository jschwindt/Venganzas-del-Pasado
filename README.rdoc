= Venganzas del Pasado {<img src="https://travis-ci.com/jschwindt/Venganzas-del-Pasado.svg?branch=master" alt="Build Status" />}[https://travis-ci.com/jschwindt/Venganzas-del-Pasado]
...
* Cache: Redis
* Webfonts: Font Awesome v4.7 (customized with http://fontello.com)

== Desarrollo

Está abierto a todos los que quieran participar. La forma de hacerlo es haciendo
