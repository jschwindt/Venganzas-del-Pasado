...
*/
		...
		_getHtmlStatus: function(media, override) {
			...
			if((typeof media.seekable === "object") && (media.seekable.length > 0)) {
				sp = (this.status.duration > 0) ? 100 * media.buffered.end(media.seekable.length-1) / this.status.duration : 100;
				cpr = 100 * media.currentTime / media.buffered.end(media.seekable.length-1);
			} else {
				sp = 100;
				cpr = cpa;
			}
		...
		_html_playHead: function(percent) {
			...
			try {
				if((typeof this.htmlElement.media.seekable === "object") && (this.htmlElement.media.seekable.length > 0)) {
					this.htmlElement.media.currentTime = percent * this.htmlElement.media.buffered.end(this.htmlElement.media.seekable.length-1) / 100;
